...
class Project(MetaProject):
    ...
    #         result.append(line)
    #         print(line)
    # todo Сделать класс полным интерфейсом для работы с тетрасофтом
    # def get_active_wells(self):
    #     network_id = self.sql_execute('SELECT * FROM WITS_NETWORK WHE')
    #
    #     select_wells = '''SELECT
    #                       ww.id,
    ...
    #                       wellbore_id
    #                       FROM
    #                       WITS_WELL ww, WITS_SOURCE ws, WITS_NETWORK wn,WITS_WELL_PROP wp JOIN
